    ...
    1: {
      ...
      content: (
        <div className="modal-content-wrapper">
          ...
          <div className="author-info">연출 박지원 (연극원 연출과 예술사 21)</div>
    ...
    2: {
      ...
      content: (
        <div className="modal-content-wrapper">
          ...
          <div className="author-info">작성자: 연출팀</div>
          <div className="content-body">
    ...
    3: {
      ...
      content: (
        <div className="modal-content-wrapper">
          ...
          <div className="author-info">작성자: 홍길동</div>
          <div className="content-body">
    ...
    4: {
      ...
      content: (
        <div className="modal-content-wrapper">
          ...
          <div className="author-info">작성자: 이몽룡</div>
          <div className="content-body">
    ...
    5: {
      ...
      content: (
        <div className="modal-content-wrapper">
          ...
          <div className="author-info">작성자: 제작팀</div>
          <div className="content-body">
    ...
    7: {
      ...
      content: (
        <div className="modal-content-wrapper">
          ...
          <div className="author-info">작성자: 아고라포비아 전체 팀</div>
          <div className="content-body">
